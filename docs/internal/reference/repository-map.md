...
| `public/logos/` | Bundled product logos for the template catalogue, database engines and image rows, mapped by `components/deploy/product-logo.tsx`; `NOTICE` carries each file's source and licence (Apache-2.0, MIT, CC0) | [`../frontend/design-system.md`](../frontend/design-system.md) §14 |
