...
| `public/logos/` | Bundled product logos for the template catalogue, database engines, containers, images and stacks, mapped by `components/product-logo.tsx`; `NOTICE` carries each file's source and licence (Apache-2.0, MIT, CC0) | [`../frontend/design-system.md`](../frontend/design-system.md) §14 |
