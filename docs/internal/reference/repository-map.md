...
| Area | Responsibility | Detailed reference |
| --- | --- | --- |
| `src/app/` | App Router layouts plus 79 page entry points across account, dashboard, audit, backups, databases, deployments, Docker, files, Git, logs, metrics, packages, processes, proxy, security, users, terminal, and login | [`../frontend/feature-map.md`](../frontend/feature-map.md) |
