...
// output, the sub-path its framework built it for and the hosting rules the
// server will apply. The page a framework falls back to (SvelteKit's
// 200.html) is its catalogue entry's reading (frameworks_node.go).
